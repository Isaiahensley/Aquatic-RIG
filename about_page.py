...
def howtouse():
    ...
    with st.expander("Uploaded File Dimensions", expanded=False):
        ...
        st.write(
            "In this example, the dimension names found in the dataset are time, depth, lat, and lon. We will put these in their respective dimensions.  \n"
            "**time** = Time  \n"
            "**depth** = Depth  \n"
            "**lat** = Latitude  \n"
            "**lon** = Longitude")
    ...
    with st.expander("Heat Map Variable", expanded=False):
        ...
        st.write(
            "The values for the variable you select will be shown on the Heat Map for every Latitude and Longitude "
